            ...
            <main className="mx-auto max-w-7xl px-4 pt-4 pb-10 sm:px-6">
              ...
              <footer className="mt-14 border-t border-ink/15 pt-5 pb-4">
                <p className="microlabel">
                  Demo build · Prices and outlooks are generated by a local simulator, not a market
                  feed · Nothing here is real data or financial advice
                </p>
              </footer>
            </main>
          </div>
